...
class _InstagramState extends State<Instagram> with TickerProviderStateMixin {
  ...
  bool doExtendBehindAppBar = true;
  ...
  void initState() {
    ...
    scrollController.addListener(() {
      setState(() {
        ...
        if (pixelsUnderAppBar == 0) {
          doExtendBehindAppBar = true;
        } else if (pixelsUnderAppBar >= 167) {
          doExtendBehindAppBar = false;
        }
      });
    });
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        extendBodyBehindAppBar: doExtendBehindAppBar,
        appBar: AppBar(
          ...
          child: NestedScrollView(
            ...
            headerSliverBuilder: (BuildContext context, bool innerBoxIsScrolled) {
              return [
                 SliverToBoxAdapter(
                  child: SizedBox(
                    height: doExtendBehindAppBar ? 110 : 50,
                    child: Padding(
                      padding: EdgeInsets.only(top: doExtendBehindAppBar ? 60 : 0, bottom: 20, left: 20),
                      child: const Text(
                        'John Jason',
